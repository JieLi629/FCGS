...
def Config_Set(model,phase):
    ...
    if phase == 1:
        parameters_group = [
        # {"params":model.linear_q.parameters(),"lr":0.5e-4},
        # {"params":model.linear_k.parameters(),"lr":0.5e-4},
        # {"params":model.linear_v.parameters(),"lr":0.5e-4},
        # {"params":model.linear_p.parameters(),"lr":0.5e-4},
        # {"params":model.linear_w.parameters(),"lr":0.5e-4},
        # {"params":model.deembeding.parameters(),"lr":0.5e-4},
        {"params":model.Q_latent,"lr":0.5e-4},
        {"params":model.Encoder_Transform.parameters(),"lr":0.5e-4},
        # {"params":model.sa3.parameters(),"lr":0.5e-4},
        # {"params":model.fp3.parameters(),"lr":0.5e-4},
        {"params":model.Decoder_Transform.parameters(),"lr":0.5e-4},
        {"params":model.Post_feac_dec.parameters(),"lr":0.5e-4},
        # {"params":model.fea_enc.parameters(),"lr":0.5e-4},
        # {"params":model.Q_l0,"lr":0.5e-4},
        # {"params":model.Q_l1,"lr":0.5e-4},
        # {"params":model.Q_l2,"lr":0.5e-4},
        # {"params":model.Q_l3,"lr":0.5e-4},
        # {"params":model.conv1.parameters(),"lr":0.5e-4},
        # {"params":model.bn1.parameters(),"lr":0.5e-4},
        # {"params":model.feac_dc_dec.parameters(),"lr":0.5e-4},
        # {"params":model.feac_ac_dec.parameters(),"lr":0.5e-4},
        # {"params":model.pre_enc.parameters(),"lr":0.5e-4},
        # {"params":model.post_dec.parameters(),"lr":0.5e-4},
        # {"params":model.Decoder_fea_dc_ME.parameters(),"lr":0.5e-4},
        # {"params":model.Decoder_fea_ac_ME.parameters(),"lr":0.5e-4},
        ...
        parameters_group = [
        {"params":model.Encoder_mask.parameters(),"lr":0.5e-5},
        {"params":model.Encoder_ga.parameters(),"lr":0.5e-5},
        {"params":model.Encoder_hyper_feac_m1.parameters(),"lr":0.5e-5},
        {"params":model.Entropy_model_fea_m1.parameters(),"lr":0.5e-5},
        {"params":model.Decoder_hyper_feac_m1.parameters(),"lr":0.5e-5},
        {"params":model.Entropy_lat_feac_m1.parameters(),"lr":0.5e-5},
        # {"params":model.latdim_2_griddim.parameters(),"lr":0.5e-5},
        # # {"params":model.Freq_Encoder.parameters(),"lr":1e-5},
        # {"params":model.feac_SpaCxt_M1.parameters(),"lr":0.5e-5},
        # {"params":model.Intra_Context_Model_M1.parameters(),"lr":0.5e-5},
        {"params":model.Decoder_gs.parameters(),"lr":0.5e-5},
        {"params":model.Decoder_fea_dc.parameters(),"lr":0.5e-5},
        {"params":model.Decoder_fea_ac.parameters(),"lr":0.5e-5}
        ]
        optimizer = optim.Adam(parameters_group,betas=(0.9,0.999),weight_decay=0)
        schedular = optim.lr_scheduler.StepLR(optimizer=optimizer,step_size=300,gamma=0.5)
    elif phase == 3:
        # parameters_group = [
        # {"params":model.Encoder_mask.parameters(),"lr":1.20.5e-5},
        # {"params":model.Encoder_ga.parameters(),"lr":2.0.5e-5},
        # {"params":model.Encoder_hyper_feac_m1.parameters(),"lr":2.0.5e-5},
        # {"params":model.Entropy_model_fea_m1.parameters(),"lr":2.0.5e-5},
        # {"params":model.Decoder_hyper_feac_m1.parameters(),"lr":2.0.5e-5},
        # {"params":model.Entropy_lat_m1.parameters(),"lr":2.0.5e-5},
        # {"params":model.Entropy_lat_m0.parameters(),"lr":2.0.5e-5},
        # {"params":model.Entropy_lat_geo.parameters(),"lr":2.0.5e-5},
        # {"params":model.Encoder_hyper_feac_m0.parameters(),"lr":2.0.5e-5},
        # {"params":model.Decoder_hyper_feac_m0.parameters(),"lr":2.0.5e-5},
        # {"params":model.Encoder_hyper_geo.parameters(),"lr":2.0.5e-5},
        # {"params":model.Decoder_hyper_geo.parameters(),"lr":2.0.5e-5},
        # {"params":model.Entropy_model_fea_m0.parameters(),"lr":2.0.5e-5},
        # {"params":model.Entropy_model_geo.parameters(),"lr":2.0.5e-5},
        # {"params":model.Decoder_gs.parameters(),"lr":2.0.5e-5},
        # {"params":model.Decoder_fea_dc.parameters(),"lr":2.0.5e-5},
        # {"params":model.Decoder_fea_ac.parameters(),"lr":2.0.5e-5},
        # {"params":model.latdim_2_griddim.parameters(),"lr":2.0.5e-5},
        # {"params":model.Freq_Encoder.parameters(),"lr":2.0.5e-5},
        # {"params":model.feac_SpaCxt_M1.parameters(),"lr":2.0.5e-5},
        # {"params":model.feac_SpaCxt_M0.parameters(),"lr":2.0.5e-5},
        # {"params":model.fea_geo_SpaCxt.parameters(),"lr":2.0.5e-5},
        # {"params":model.Intra_Context_Model_M1.parameters(),"lr":2.0.5e-5},
        # {"params":model.Intra_Context_Model_M0.parameters(),"lr":2.0.5e-5},
        # {"params":model.ad_fe,"lr":2.0.5e-5},
        # {"params":model.ad_op,"lr":2.0.5e-5},
        # {"params":model.ad_sc,"lr":2.0.5e-5},
        # {"params":model.ad_ro,"lr":2.0.5e-5}
        # ]
        parameters_group = [
        {"params":model.Encoder_mask.parameters(),"lr":0.5e-5},
        {"params":model.Encoder_ga.parameters(),"lr":0.5e-5},
        ...
        {"params":model.Entropy_model_fea_m1.parameters(),"lr":0.5e-5},
        {"params":model.Decoder_hyper_feac_m1.parameters(),"lr":0.5e-5},
        {"params":model.Entropy_lat_m1.parameters(),"lr":0.5e-5},
        {"params":model.Entropy_lat_m0.parameters(),"lr":0.5e-5},
        {"params":model.Entropy_lat_geo.parameters(),"lr":0.5e-5},
        ...
        {"params":model.Decoder_fea_ac.parameters(),"lr":0.5e-5},
        {"params":model.latdim_2_griddim.parameters(),"lr":0.5e-5},
        {"params":model.Freq_Encoder.parameters(),"lr":0.5e-5},
        {"params":model.feac_SpaCxt_M1.parameters(),"lr":0.5e-5},
        ...
        optimizer = optim.Adam(parameters_group,betas=(0.9,0.999),weight_decay=0)
        schedular = optim.lr_scheduler.StepLR(optimizer=optimizer,step_size=500,gamma=0.5)
...
def load_state_dict(model,ckpt=None,ckpt1=None):
    ...
    # dict = {'sa1.conv_blocks.0.0.weight'}
    ...
    if ckpt1:
        pretrained_dict_release = {k:v for k,v in ckpt1.items() if k.split('.')[0] in dict and k != 'fp1.mlp_convs.0.weight'}
