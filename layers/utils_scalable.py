...
from layers.pointnetpp_utils_scable import Encoder, Decoder, PostProcess
...
class get_model(nn.Module):
    def __init__(self):
        ...
        # self.init_norm = nn.LayerNorm(56)
